...
@pytest.mark.parametrize("user_cred", read_credentials_from_excel(r"C:\Users\Ola\PycharmProjects\Py2xAPIAutomationFramework\pythonProject1\tests\test\crud\datadriventesting/testdata_ddt_123.xlsx"))
